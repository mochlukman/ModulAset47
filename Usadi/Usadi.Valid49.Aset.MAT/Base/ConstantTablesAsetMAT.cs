...
namespace Usadi.Valid49.BO
{
    ...
    public class ConstantTablesAsetMAT
    {
        ...
        public const string XMLINVBAST = "Invbast";
        public const string XMLINVNOTA = "Invnota";
        public const string XMLINVPENYALURAN = "Invpenyaluran";
        public const string XMLINVPENYALURANDET = "Invpenyalurandet";
        public const string XMLINVREAL = "Invreal";
        public const string XMLINVREALDET = "Invrealdet";
        public const string XMLINVRETUR = "Invretur";
        public const string XMLINVRETURDET = "Invreturdet";
        public const string XMLINVSPB = "Invspb";
        public const string XMLINVSPBDET = "Invspbdet";
